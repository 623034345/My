...
//  RatingBar
//
//  Created by fornowIOS on 15/3/26.
...
-(void)setImageDeselected:(NSString *)deselectedName halfSelected:(NSString *)halfSelectedName fullSelected:(NSString *)fullSelectedName andDelegate:(id<RatingBarDelegate>)delegate{
    ...
    float x = width + 3;
    [_s1 setFrame:CGRectMake(0 * x, 0, width, height)];
    [_s2 setFrame:CGRectMake(1 * x, 0, width, height)];
    [_s3 setFrame:CGRectMake(2 * x, 0, width, height)];
    [_s4 setFrame:CGRectMake(3 * x, 0, width, height)];
    [_s5 setFrame:CGRectMake(4 * x, 0, width, height)];
