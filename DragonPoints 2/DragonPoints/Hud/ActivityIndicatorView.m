...
- (void)addCircles
{
    ...
    [array addObject:UIRED_NORMAL];
    [array addObject:UIBLUE_NORMAL];
//    [array addObject:UIColorWithRGB(171, 205, 6)];
//    [array addObject:UIColorWithRGB(66, 149, 209)];
//    [array addObject:UIColorWithRGB(72, 187, 161)];
//    [array addObject:UIColorWithRGB(155, 133, 189)];
    for (NSUInteger i = 0; i < self.numberOfCircles; i++)
    {
        ...
        [circle.layer addAnimation:[self createAnimationWithDuration:self.duration delay:(i * self.delay)]
                            forKey:@"scale"];
