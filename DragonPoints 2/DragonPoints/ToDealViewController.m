...
@interface ToDealViewController ()

@end

@implementation ToDealViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"现金支付订单处理";
    ...
    _lab6.text = [NSString stringWithFormat:@"结算金额:78.00"];
    _lab7.text = [NSString stringWithFormat:@"应付金额:22.00"];
