...
//赋值
- (void)returnCityInfo:(City1Block)block {
    _cityInfo = block;
}
...
- (void)addTableView {
    ...
    //tableView
    _mainTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, screen_width / 4 + 1, screen_height - 64) style:UITableViewStylePlain];
